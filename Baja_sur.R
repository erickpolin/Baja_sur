...
attach(ConcBaja_sur) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcBaja_sur<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcBaja_sur) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcBaja_sur$factor,to.data.frame=TRUE)
...
ConcBaja_sur$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcBaja_sur$MAXT<-ConcBaja_sur$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcBaja_sur<-ConcBaja_sur[with(ConcBaja_sur, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcBaja_sur$ACUMULA<-cumsum(ConcBaja_sur$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcBaja_sur[dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcBaja_sur<-rbind(ConcBaja_sur[1:(dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1]+1),],
                             ConcBaja_sur[(dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1]+1):dim(ConcBaja_sur[1])[1],])
  
  b1<-tam_dec*i-ConcBaja_sur[dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcBaja_sur[(dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcBaja_sur[(dim(ConcBaja_sur[ConcBaja_sur$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcBaja_sur$ACUMULA2<-cumsum(ConcBaja_sur$factor)

#aqu? estamos creando una variable que se llama decil que solo tiene ceros
ConcBaja_sur$DECIL<-0
...
ConcBaja_sur[(ConcBaja_sur$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcBaja_sur[((ConcBaja_sur$ACUMULA2>tam_dec*i)&(ConcBaja_sur$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcBaja_sur[ConcBaja_sur$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Baja_sur")
write.dbf(ConcBaja_sur,file="ConcBaja_sur2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Baja_sur")
write.dbf(ConcBaja_sur,file="ConcBaja_sur2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Baja_sur")
Conc2010<-read.dbf("ConcBaja_sur2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Baja_sur por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Baja_sur INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Baja_sur NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Baja_sur")
Conc2018<-read.dbf("ConcBaja_sur2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Baja_sur Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Baja_sur INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Baja_sur NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Baja_sur NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Baja_sur NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Baja_sur NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Baja_sur NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Baja_sur por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Baja_sur Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Baja_sur NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Baja_sur NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Baja_sur INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Baja_sur INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
